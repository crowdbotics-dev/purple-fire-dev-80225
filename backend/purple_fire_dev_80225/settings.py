"""
Django settings for purple_fire_dev_80225 project.
...
ROOT_URLCONF = 'purple_fire_dev_80225.urls'
...
WSGI_APPLICATION = 'purple_fire_dev_80225.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_fire_dev_80225 API",
    "DESCRIPTION": "API documentation for purple_fire_dev_80225 App",
    "VERSION": "v1",
}
